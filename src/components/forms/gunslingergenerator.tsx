...
const GunslingerComponent: React.FC = () => {
  ...
  function promptTextWithAttributes () {
    var metaText= 'Create a imaginary name and background story of a western gunslinger with the following traits: ';
    setPrompt(metaText.concat(trait.join(' ')));
    console.log(prompt);
  }

  function imageTextWithAttributes () {
    var metaText= 'Western style drawn image of a gunslinger with the following traits: ';
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={generateImage} className="center bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Generate image</button>
